// src/pages/customer/Dashboard.jsx - COMPLETE FIXED FILE - REPLACE YOUR ENTIRE CustomerDashboard.jsx WITH THIS
  ...
  return (
    <div className="dashboard-container">
      <header className="dashboard-header">
        <h1>Chào mừng, {user?.fullName || user?.name || user?.username || 'Khách hàng'}!</h1>
